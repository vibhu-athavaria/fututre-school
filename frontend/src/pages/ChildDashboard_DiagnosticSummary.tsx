...
interface ChildDashboard_DiagnosticSummaryProps {
  subject: string;
  assessmentId: string;
  cachedReport?: any;
...
export const ChildDashboard_DiagnosticSummary: React.FC<
  ChildDashboard_DiagnosticSummaryProps
> = ({ subject, assessmentId, cachedReport, onCacheReport, onStartCourse }) => {
  ...
  useEffect(() => {
    ...
    if (cachedReport) {
      // Already fetched before — load from cache
    ...
    const fetchAssessment = async () => {
      try {
          const res = await axios.get(`/api/v1/assessments/${assessmentId}/report`, {
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900">Strong Areas</h4>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900">Developing</h4>
