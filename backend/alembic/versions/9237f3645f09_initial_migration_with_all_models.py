...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_course_question_links_id'), 'courseion_links', ['id'], unique=False)
    op.create_table('courseons',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('course_id', sa.Integer(), nullable=False),
    ...
    sa.Column('position', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['course ['courseE'),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_courseons_id'), table_name='course_sections')
